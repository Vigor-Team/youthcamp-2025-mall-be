...
.PHONY: gen-gateway
gen-gateway:
	@cd app/gateway && cwgo server --type HTTP --idl ../../idl/gateway/user_api.proto --service gateway --module github.com/Vigor-Team/youthcamp-2025-mall-be/app/gateway -I ../../idl
