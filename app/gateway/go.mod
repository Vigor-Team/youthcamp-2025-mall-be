module github.com/Vigor-Team/youthcamp-2025-mall-be/app/gateway
...
require (
	github.com/Vigor-Team/youthcamp-2025-mall-be/app/llm v0.0.0-20250218143814-0ecfda7a2298
