...
var file_auth_page_proto_depIdxs = []int32{
	...
	2, // 3: gateway.auth.AuthService.register:output_type -> gateway.common.Empty
	2, // 4: gateway.auth.AuthService.login:output_type -> gateway.common.Empty
	2, // 5: gateway.auth.AuthService.logout:output_type -> gateway.common.Empty
