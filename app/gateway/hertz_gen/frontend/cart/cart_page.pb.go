...
var file_cart_page_proto_depIdxs = []int32{
	0, // 0: gateway.cart.CartService.AddCartItem:input_type -> gateway.cart.AddCartReq
	1, // 1: gateway.cart.CartService.GetCart:input_type -> gateway.common.Empty
	1, // 2: gateway.cart.CartService.AddCartItem:output_type -> gateway.common.Empty
	1, // 3: gateway.cart.CartService.GetCart:output_type -> gateway.common.Empty
