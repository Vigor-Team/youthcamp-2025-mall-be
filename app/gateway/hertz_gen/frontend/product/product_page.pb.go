...
var file_product_page_proto_goTypes = []interface{}{
	(*ProductReq)(nil),        // 0: gateway.product.ProductReq
...
var file_product_page_proto_depIdxs = []int32{
	0, // 0: gateway.product.ProductService.GetProduct:input_type -> gateway.product.ProductReq
	1, // 1: gateway.product.ProductService.SearchProducs:input_type -> gateway.product.SearchProductsReq
	2, // 2: gateway.product.ProductService.GetProduct:output_type -> gateway.common.Empty
	2, // 3: gateway.product.ProductService.SearchProducs:output_type -> gateway.common.Empty
