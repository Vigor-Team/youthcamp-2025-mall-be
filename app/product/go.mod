module github.com/Vigor-Team/youthcamp-2025-mall-be/app/product
...
require (
	github.com/Vigor-Team/youthcamp-2025-mall-be/app/user v0.0.0-20250205060104-36110672d989
